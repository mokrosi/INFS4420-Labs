<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="process-transaction.aspx.cs" Inherits="INFS4420Labs.process_transaction" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="w-100">
        <tr>
            <td colspan="2">
                <asp:GridView ID="grdTranscations" runat="server" AllowPaging="True" AutoGenerateSelectButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnSelectedIndexChanged="grdTranscations_SelectedIndexChanged" Width="800px">
        ...
        <tr>
            <td style="height: 21px; width: 553px">
